...
public class RotondAndesServices {
	...
	public Response getVideo( @PathParam( "id" ) Long id )
	{
		...
		try
		{
			Restaurante v = tm.buscarVideoPorId( id );
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response addVideo(Restaurante video) {
		RotondAndesTM tm = new RotondAndesTM(getPath());
		try {
			tm.addVideo(video);
		} catch (Exception e) {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response addVideo(List<Restaurante> videos) {
		RotondAndesTM tm = new RotondAndesTM(getPath());
		try {
			tm.addVideos(videos);
		} catch (Exception e) {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response updateVideo(Restaurante video) {
		RotondAndesTM tm = new RotondAndesTM(getPath());
		try {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response deleteVideo(Restaurante video) {
		RotondAndesTM tm = new RotondAndesTM(getPath());
		try {
